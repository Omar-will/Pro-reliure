...
const MentionsLegales = () => {
  return (
    <div className="mentions-legales">
      ...
      <p>Le site Internet est susceptible de reproduire des œuvres de propriété intellectuelle. Ces œuvres peuvent appartenir à l’éditeur du site ou à des tiers. Dans ce dernier cas, les œuvres sont reproduites par l’éditeur avec l’autorisation de ces tiers.
...
Toute exploitation non autorisée du site Internet ou de l’un quelconque des éléments qu’il contient pourra être considérée comme constitutive d’une contrefaçon et poursuivie conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.</p>
       <p><strong>OBLIGATIONS DES UTILISATEURS</strong></p>
